...
function backToPrev() {
  ...
  document.querySelector("input[name=point_player_1]").value = point_player_1_old;
  document.querySelector("input[name=point_player_2]").value = point_player_2_old;
  document.querySelector("input[name=point_player_3]").value = point_player_3_old;
  document.querySelector("input[name=point_player_4]").value = point_player_4_old;
}

document.getElementById("backToNow").addEventListener("click", backToNow);
